...
//
// The API key comes from the environment (MOONSHOT_API_KEY). No key = AI off, PDF still works.
...
// API key: set MOONSHOT_API_KEY in the environment. Never hardcode it here.
function embeddedKey(): string {
...
export function aiConfig(): AiConfig {
  ...
  const apiKey = cleanKey(embeddedKey());
