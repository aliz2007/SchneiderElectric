...
// Rating wizard: one capability per screen, rubric anchors, autosave, shortcuts.
...
export default function Wizard({
  ...
  // local state: ratings, cluster notes, position, save status
  ...
  // pick a level, save it right away
  ...
  // note edits autosave after 700ms idle
  ...
  // submit locks the assessment for this lens
  const doSubmit = () => {
    setSubmitError(null);
    startSubmit(async () => {
      try {
